import React, { Dispatch, MouseEvent, ReactHTML, SetStateAction, useRef, useState } from 'react'
import {
    CalendarIcon,
    EmojiHappyIcon,
    LocationMarkerIcon,
            ...
            <form className="flex flex-1 flex-col">
                ...
                {imageUrlBoxIsOpen && (
                    <form className= 'mt-5 flex rounded-lg bg-twitter/80 py-2 px-4'> 
                        ...
                        />
                        <button onClick={addImageToTweet} type='submit'  className="font-bold text-white">Add Image
                        </button>
                    </form>
                )}
